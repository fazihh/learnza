					...
					<div className="row align-items-center">
							...
							<div className="row g-2">
								<div className="col-md-6 text-center" data-aos="fade-right" data-aos-delay={200}>
									<div className="position-relative">
										<img className="rounded-4" src="/assets/imgs/pages/learning/page-about/img-1.png" alt="AstraX" />
								...
								<div className="col-md-6 mt-md-8 mt-10 pt-md-0 pt-5 text-center">
									<div className="d-flex align-items-start text-start mb-5 ms-md-0 ms-5">
										...
										<div className="ms-3">
											...
											<p className="mb-0">Line make <span className="text-primary">/Per sec</span></p>
										</div>
									</div>
									<img className="rounded-4" data-aos="fade-up" data-aos-delay={200} src="/assets/imgs/pages/learning/page-about/img-2.png" alt="AstraX" />
								</div>
							</div>
						</div>
						<div className="col-lg-5 offset-lg-1 col-md-12 order-2 ">
							<div className="d-flex align-items-center gap-3">
								...
								<span className="btn-text text-primary">since from 2000</span>
							</div>
							<h2 className="my-3 text-anime-style-3">Navigate success with our ai expertise</h2>
							...
							<ul className="list-unstyled d-flex flex-wrap">
								<li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100" data-aos="fade-up" data-aos-delay={0}>
									<div className="position-relative">
										<svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
											<circle className="fill-primary" cx={7} cy={7} r={7} fill="#794AFF" />
											<path d="M10.5308 4.36671C10.4785 4.31395 10.4162 4.27207 10.3476 4.24349C10.279 4.21491 10.2055 4.2002 10.1312 4.2002C10.0568 4.2002 9.98327 4.21491 9.91467 4.24349C9.84607 4.27207 9.78381 4.31395 9.73148 4.36671L5.53768 8.56613L3.77573 6.79855C3.72139 6.74606 3.65725 6.70479 3.58697 6.67709C3.51668 6.64939 3.44163 6.63581 3.3661 6.63712C3.29056 6.63842 3.21603 6.6546 3.14674 6.68471C3.07746 6.71482 3.01478 6.75829 2.9623 6.81262C2.90981 6.86696 2.86854 6.9311 2.84084 7.00138C2.81314 7.07166 2.79956 7.14672 2.80087 7.22225C2.80217 7.29778 2.81835 7.37232 2.84846 7.4416C2.87857 7.51089 2.92204 7.57356 2.97637 7.62605L5.13801 9.78768C5.19034 9.84045 5.2526 9.88232 5.32119 9.9109C5.38979 9.93948 5.46337 9.9542 5.53768 9.9542C5.612 9.9542 5.68557 9.93948 5.75417 9.9109C5.82277 9.88232 5.88503 9.84045 5.93736 9.78768L10.5308 5.19421C10.588 5.1415 10.6336 5.07752 10.6648 5.00631C10.696 4.9351 10.7121 4.8582 10.7121 4.78046C10.7121 4.70272 10.696 4.62582 10.6648 4.55461C10.6336 4.4834 10.588 4.41942 10.5308 4.36671Z" fill="white" />
										</svg>
									</div>
									<p className="mb-0 text-primary fw-bold btn-text text-uppercase">Creative Writing</p>
								</li>
								<li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100" data-aos="fade-up" data-aos-delay={0}>
									<div className="position-relative">
										<svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
									...
									<p className="mb-0 text-primary fw-bold btn-text text-uppercase">Film and Animation</p>
								</li>
								<li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100" data-aos="fade-up" data-aos-delay={200}>
									<div className="position-relative">
										<svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
											<circle className="fill-primary" cx={7} cy={7} r={7} fill="#794AFF" />
											<path d="M10.5308 4.36671C10.4785 4.31395 10.4162 4.27207 10.3476 4.24349C10.279 4.21491 10.2055 4.2002 10.1312 4.2002C10.0568 4.2002 9.98327 4.21491 9.91467 4.24349C9.84607 4.27207 9.78381 4.31395 9.73148 4.36671L5.53768 8.56613L3.77573 6.79855C3.72139 6.74606 3.65725 6.70479 3.58697 6.67709C3.51668 6.64939 3.44163 6.63581 3.3661 6.63712C3.29056 6.63842 3.21603 6.6546 3.14674 6.68471C3.07746 6.71482 3.01478 6.75829 2.9623 6.81262C2.90981 6.86696 2.86854 6.9311 2.84084 7.00138C2.81314 7.07166 2.79956 7.14672 2.80087 7.22225C2.80217 7.29778 2.81835 7.37232 2.84846 7.4416C2.87857 7.51089 2.92204 7.57356 2.97637 7.62605L5.13801 9.78768C5.19034 9.84045 5.2526 9.88232 5.32119 9.9109C5.38979 9.93948 5.46337 9.9542 5.53768 9.9542C5.612 9.9542 5.68557 9.93948 5.75417 9.9109C5.82277 9.88232 5.88503 9.84045 5.93736 9.78768L10.5308 5.19421C10.588 5.1415 10.6336 5.07752 10.6648 5.00631C10.696 4.9351 10.7121 4.8582 10.7121 4.78046C10.7121 4.70272 10.696 4.62582 10.6648 4.55461C10.6336 4.4834 10.588 4.41942 10.5308 4.36671Z" fill="white" />
									...
									<p className="mb-0 text-primary fw-bold btn-text text-uppercase">Fashion Design</p>
								</li>
								<li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100" data-aos="fade-up" data-aos-delay={200}>
									<div className="position-relative">
										<svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
									...
									<p className="mb-0 text-primary fw-bold btn-text text-uppercase">Photography</p>
								</li>
							</ul>
							<Link href="/#" className="btn btn-outline-secondary mt-3 hover-up">
								<span>About us</span>
