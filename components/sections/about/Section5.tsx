...
export default function Section5() {
	return (
		<>
			...
			<section className="elearning-home-section-5 position-relative overflow-hidden pt-120 pb-120 bg-white rounded-bottom-4 z-35">
				<div className="container position-relative z-1">
					<div className="row">
						<div className="text-start">
							...
							<h2 className="text-anime-style-2 mb-0">Our avengers</h2>
						</div>
					</div>
				</div>
				<div className="pricing__area pricing__bg py-80">
					<div className="accordion section-portfolio-2 d-flex flex-column flex-lg-row align-items-center">
						<div className="accordion-item wow img-custom-anim-top expand">
							<div className="accordion-img position-relative" data-background="assets/imgs/pages/learning/page-home/home-section-5/portrait.png" />
							<div className="accordion-link">
								<div className="accordion-link-item">
									<span className="btn-text text-primary opacity-50">cto</span>
									<h6>
										<Link href="/instructor-details"> Isabella F. Monroe </Link>
									</h6>
									<p>We offer a wide range of digital marketing services that cater to business of all sizes.</p>
									<ul className="list-unstyled d-flex mb-0 gap-2 justify-content-center flex-wrap">
										<li>
											<Link href="/#">
				...
				<div className="container">
					<div className="row">
						<div className="text-center d-flex flex-wrap justify-content-center align-items-center gap-lg-5 gap-3">
							<h6 className="mb-0">Become a Astrax eLearning platform instructor.</h6>
